...
public class Builder extends Unit implements Goldminer, Lumberman{
    ...
    public void setupActions()
    {
        ...
        addActionButton(actionButtons, new UIActionButton(Assets.iconGather, () -> {player.getController().setAction("gather"); setCancelMenu();}, "Gather", 'g'));
        addActionButton(actionButtons, new UIActionButton(Assets.iconBuild, () -> {setCurrentMenu(buildMenu);}, "Build", 'b'), 2, 0);
        ...
        addActionButton(buildMenu, new UIActionButton(Assets.iconCancel, () -> {setDefaultMenu();}, "Cancel", 'c'), 2, 2);
